...
?>
    ...
    <head>
        ...
        <title> Manege Products| දොරකඩට</title>
    </head>

    <body class="studentbody">
        <div class="col-12">
            <div class="row text-sm-center bg-success ">
                <div class="mt-3 mb-3 fs-1 text-decoration-underline fw-bold text-warning"><i class="bi bi-motherboard"></i> Manege Products...!</div>
            </div>
        </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Manege Product</span>
                        </div>
                    </li>
                </ol>
            </nav>
                        ...
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-dark hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row" class="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap dark:text-white ">
                                    ...
                                    ?>
                                    <img class="w-10 h-10 gap-1" src="<?php echo $image_data["path"] ?>">
                                    <div class="pl-3">
                                        <div class="font-normal text-gray-500"><?php echo $selected_data["title"] ?></div>
                                    </div>
                                </th>
                                <td class="py-4 px-6">
                                    Rs. <?php echo $selected_data["price"] ?> .00
                                </td>
                                <td class="py-4 px-6">
                                    <div class="flex items-center">
                                        <?php echo $selected_data["qty"] ?>
                                    </div>
                                </td>
                                <td class="py-4 px-6">
                                    ...
                                    ?>
                                        <div class="row col-12">
                                            <div class="col-3 border-end border-success">
                                                <button id="BP<?php echo $selected_data['id']; ?>" class="btn btn-primary " onclick="blockProduct('<?php echo $selected_data['id']; ?>');">Block</button>
                                            </div>
                                            <div class="col-4">
                                                <button class="btn btn-danger" onclick="removeProduct();"> Remove </button>
                                            </div>
                                            <div class="col-5">
                                            <button class="btn btn-warning" onclick="sendId(<?php echo $selected_data['id']; ?>);">Update Product</button>
                                            </div>
                                        </div>
                                    ...
                                    ?>
                                        <div>
                                            <button id="BP<?php echo $selected_data['id']; ?>" class="btn btn-danger" onclick="blockProduct('<?php echo $selected_data['id']; ?>');">Unblock</button>
                                        </div>
